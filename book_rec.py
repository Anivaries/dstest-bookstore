...
tolkien_readers = dataset_lowercase['User-ID'][(dataset_lowercase['Book-Title'] == 'the fellowship of the ring (the lord of the rings, part 1)') & (
...
for LoR_book in LoR_list:
    ...
    for book_title in list(dataset_of_other_books.columns.values):
        ...
        # tab = (
        #     ratings_data_raw.loc[ratings_data_raw['Book-Title']
        #                          == book_title, 'Book-Rating']
        #     .mean()
        # )
        # avgrating.append(tab)
        tab = (ratings_data_raw[ratings_data_raw['Book-Title'] ==
               book_title].groupby('Book-Title').mean())
...
# print("Average rating of LOR:", ratings_data_raw[ratings_data_raw['Book-Title'] ==
#       'the fellowship of the ring (the lord of the rings, part 1'].groupby(ratings_data_raw['Book-Title']).mean())
rslt = result_list[0]
print(avgrating)
print(rslt)
